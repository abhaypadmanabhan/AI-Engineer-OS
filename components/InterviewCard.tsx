  ...
  return (
    <Card className="my-3">
      <Collapsible open={open} onOpenChange={setOpen}>
        ...
        <CollapsibleContent className="border-t border-border px-4 pb-4 pt-3 text-sm text-muted-foreground">
          <div className="mb-1 text-xs uppercase tracking-wide text-accent">Expected answer</div>
          {a}
        </CollapsibleContent>
      </Collapsible>
    </Card>
